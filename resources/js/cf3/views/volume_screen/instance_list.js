...
var DraggableInstances = Backbone.View.extend({
    ...
    initialize: function(options) {
        ...
        this.volumes.bind('change:status', this.volume_status_changed, this);
        this.volumes.bind('remove', this.remove_volume, this);

        this.instances.bind('change:state', this.instance_state_changed, this);
        this.instances.bind('remove', this.remove_instance, this);
    },
    ...
    render: function() {
        ...
        $.each(this.instances.models, function(i, instance) {
            if (instance.get('state_is_active')) {
                running_instances++;
