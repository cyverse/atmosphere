...
def parse_location(location):
    ...
    UserProfile.objects.filter(user__username=owner_name): # username found on bucket
        ...
        owner_name = search_results['owner_name']
        if owner_name not in ['admin', 'mi'] and\
        UserProfile.objects.filter(user__username=owner_name): # username found on image
            user_found = owner_name
        else:
