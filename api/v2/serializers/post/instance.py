...
class InstanceSerializer(serializers.ModelSerializer):
    ...
    allocation_source_id = serializers.CharField(
    ...
    def to_internal_value(self, data):
        ...
        allocation_source = allocation_source_queryset.filter(
            allocation_source__uuid=allocation_source_id
        )
    ...
    class Meta:
        model = Instance
        fields = (
            'uuid', 'provider_uuid', 'identity', 'name', 'project',
            'size_alias', 'source_alias', 'scripts', 'deploy', 'extra',
            'allocation_source_id'
        )
