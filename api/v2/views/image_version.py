    ...
    def get_queryset(self):
        ...
        if type(request_user) != AnonymousUser:
            ...
            shared_set = ImageVersion.objects.filter(
                    only_current(),
                    only_current_machines_in_version(),
                    Q(membership=all_group_ids) | Q(machines__members__in=all_group_ids)
                    )
        ...
        return (public_set | shared_set | my_set | admin_set).distinct().order_by('-machines__instance_source__start_date')
