...
from api.identity import IdentityList, Identity, IdentityDetail,\
    IdentityDetailList
...
private_apis = patterns(
    ...
    url(identity_specific + r'/image_export/(?P<machine_request_id>%s)$'
        % (id_match,), ExportRequest.as_view(), name='machine-export'),
    ...
    url(identity_specific + r'/hypervisor/(?P<hypervisor_id>%s)$'
        % (id_match,), HypervisorDetail.as_view(), name='hypervisor-detail'),
...
public_apis = format_suffix_patterns(patterns(
    ...
    url(identity_specific + r'/machine/(?P<machine_id>%s)/license$'
        % uuid_match, MachineLicense.as_view(), name='machine-license'),
    url(identity_specific + r'/machine/(?P<machine_id>%s)' % uuid_match +
        '/icon$', MachineIcon.as_view(), name='machine-icon'),

    url(provider_specific + r'/identity$', IdentityList.as_view(),
        name='identity-list'),
    url(identity_specific + r'$', Identity.as_view(),
    ...
    url(identity_specific + r'/request_image/(?P<machine_request_id>%s)$'
        % (uuid_match,), MachineRequest.as_view(), name='machine-request'),
