...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        try:
            featured_tag = orm.Tag.objects.get(name__iexact="featured")
        except orm.Tag.DoesNotExist:
            featured_tag = orm.Tag.objects.create(name='Featured',
                    description="Featured applications receive priority"
                    " ordering over non-featured applications")
        featured_apps = orm.Application.objects.filter(featured=True)
        for app in featured_apps:
            app.tags.add(featured_tag)
    ...
    models = {
        ...
        'core.flow': {
            ...
            'start_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 25, 0, 0)'}),
