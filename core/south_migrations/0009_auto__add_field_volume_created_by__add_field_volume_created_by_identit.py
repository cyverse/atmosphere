...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Machine.created_by_identity'
        db.add_column('machine', 'created_by_identity',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Identity'], null=True),
                      keep_default=False)

        # Adding field 'Instance.created_by_identity'
        db.add_column('instance', 'created_by_identity',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Identity'], null=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Machine.created_by_identity'
        db.delete_column('machine', 'created_by_identity_id')

        # Deleting field 'Instance.created_by_identity'
        db.delete_column('instance', 'created_by_identity_id')
