...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Provider.description'
        db.add_column('provider', 'description',
                      self.gf('django.db.models.fields.TextField')(default='<No Description Provided>'),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Provider.description'
        db.delete_column('provider', 'description')
    ...
    models = {
        ...
        'core.flow': {
            ...
            'start_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 4, 28, 0, 0)'}),
