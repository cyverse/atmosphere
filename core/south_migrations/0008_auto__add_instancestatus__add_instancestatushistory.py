...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'InstanceStatus'
        db.create_table('instance_status', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=128)),
        ))
        db.send_create_signal('core', ['InstanceStatus'])

        # Adding model 'InstanceStatusHistory'
        db.create_table('instance_status_history', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('instance', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Instance'])),
            ('status', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.InstanceStatus'])),
            ('start_date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 8, 13, 0, 0))),
            ('end_date', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
        ))
        db.send_create_signal('core', ['InstanceStatusHistory'])


    def backwards(self, orm):
        # Deleting model 'InstanceStatus'
        db.delete_table('instance_status')

        # Deleting model 'InstanceStatusHistory'
        db.delete_table('instance_status_history')
    ...
    models = {
        ...
        'core.instancestatushistory': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'instance': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['core.Instance']"}),
            'start_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 13, 0, 0)'}),
