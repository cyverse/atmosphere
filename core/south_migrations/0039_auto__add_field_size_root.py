...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Size.root'
        db.add_column('size', 'root',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Size.root'
        db.delete_column('size', 'root')
    ...
    models = {
        ...
        'core.flow': {
            ...
            'start_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 1, 17, 0, 0)'}),
