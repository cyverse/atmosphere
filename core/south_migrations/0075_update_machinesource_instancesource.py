...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for volume in orm.Volume.objects.order_by('id'):
            orm.VolumeSource.objects.get_or_create(
                    ...
                    size=volume.size,
                    identifier=volume.alias,
                    provider=volume.provider,
                    created_by=volume.created_by,
                    created_by_identity=volume.created_by_identity,
    ...
    models = {
        ...
        'core.application': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "UUID('1f7dab2d-f643-4507-badd-7ec49848f2cb')", 'unique': 'True', 'max_length': '36'})
        },
        ...
        'core.identity': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'provider': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['core.Provider']"}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "UUID('acf30cff-7b26-4c85-8eb9-5fb469dcfbd8')", 'unique': 'True', 'max_length': '36'})
        },
        ...
        'core.project': {
            ...
            'start_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "UUID('84aee3ac-3d69-4bc8-b4f0-c17b668dd797')", 'unique': 'True', 'max_length': '36'}),
        ...
        'core.provider': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "UUID('3e6c11f5-6a21-4139-afdf-0d120c67ab8d')", 'unique': 'True', 'max_length': '36'}),
