...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Provider.uuid'
        db.add_column('provider', 'uuid',
                      self.gf('django.db.models.fields.CharField')(max_length=36, unique=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Identity.uuid'
        db.add_column('identity', 'uuid',
                      self.gf('django.db.models.fields.CharField')(max_length=36, unique=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Project.uuid'
        db.add_column('project', 'uuid',
                      self.gf('django.db.models.fields.CharField')(max_length=36, unique=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Provider.uuid'
        db.delete_column('provider', 'uuid')

        # Deleting field 'Identity.uuid'
        db.delete_column('identity', 'uuid')

        # Deleting field 'Project.uuid'
        db.delete_column('project', 'uuid')
