...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        #ARTIFACTS from a previous migration..
        ## Deleting field 'ProviderMachine.id'
        #db.delete_column('provider_machine', u'id')

        ## Adding field 'ProviderMachine.instancesource_ptr'
        #db.add_column('provider_machine', u'instancesource_ptr',
        #              self.gf('django.db.models.fields.related.OneToOneField')(default=-1, to=orm['core.InstanceSource'], unique=True, primary_key=True),
        #              keep_default=False)

        # Deleting field 'Instance.provider_machine'
        db.delete_column('instance', 'provider_machine_id')


        # Changing field 'Instance.source'
        db.alter_column('instance', 'source_id', self.gf('django.db.models.fields.related.ForeignKey')(default=-1, to=orm['core.InstanceSource']))
    ...
    models = {
        ...
        'core.application': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "UUID('fe9a050c-af01-46a0-87f6-5a958b665ca5')", 'unique': 'True', 'max_length': '36'})
        },
        ...
        'core.flow': {
            ...
            'start_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 1, 15, 0, 0)'}),
        ...
        'core.identity': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'provider': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['core.Provider']"}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "UUID('db2c28a0-6e80-4429-bbce-aae514230b05')", 'unique': 'True', 'max_length': '36'})
        },
        ...
        'core.project': {
            ...
            'start_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "UUID('c8978be8-045a-440a-90ab-92b5ec564ea3')", 'unique': 'True', 'max_length': '36'}),
        ...
        'core.provider': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "UUID('f963f1a0-6198-4d83-b39c-aff2dc108681')", 'unique': 'True', 'max_length': '36'}),
