...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('script_type', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=128)),
            ('description', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal('core', ['ScriptType'])

        # Adding initial fields for 'ScriptType'
        orm.ScriptType.objects.create(
                name='URL', description="The complete URL address "\
                "(Ex: https://www.github.com/example/example_script.sh")
        orm.ScriptType.objects.create(
                name='Raw Text',
                description="The complete script including a 'shebang' "
                "(Ex: #!/bin/bash; ...)")
      

        # Adding model 'BootScript'
        db.create_table('boot_script', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=128)),
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.AtmosphereUser'])),
            ('script_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.ScriptType'])),
            ('script_text', self.gf('django.db.models.fields.TextField')()),
            ('run_every_deploy', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('core', ['BootScript'])

        # Adding M2M table for field applications on 'BootScript'
        m2m_table_name = db.shorten_name('boot_script_applications')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('bootscript', models.ForeignKey(orm['core.bootscript'], null=False)),
            ('application', models.ForeignKey(orm['core.application'], null=False))
        ))
        db.create_unique(m2m_table_name, ['bootscript_id', 'application_id'])

        # Adding M2M table for field instances on 'BootScript'
        m2m_table_name = db.shorten_name('boot_script_instances')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('bootscript', models.ForeignKey(orm['core.bootscript'], null=False)),
            ('instance', models.ForeignKey(orm['core.instance'], null=False))
        ))
        db.create_unique(m2m_table_name, ['bootscript_id', 'instance_id'])


    def backwards(self, orm):
        # Deleting model 'ScriptType'
        db.delete_table('script_type')

        # Deleting model 'BootScript'
        db.delete_table('boot_script')

        # Removing M2M table for field applications on 'BootScript'
        db.delete_table(db.shorten_name('boot_script_applications'))

        # Removing M2M table for field instances on 'BootScript'
        db.delete_table(db.shorten_name('boot_script_instances'))
    ...
    models = {
        ...
        'core.application': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "UUID('71d7912c-3072-4908-95b1-331e00b66d9d')", 'unique': 'True', 'max_length': '36'})
        },
        ...
        'core.flow': {
            ...
            'start_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 1, 16, 0, 0)'}),
        ...
        'core.identity': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'provider': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['core.Provider']"}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "UUID('190d7cf8-3df2-48ce-9141-9a77ce469aec')", 'unique': 'True', 'max_length': '36'})
        },
        ...
        'core.project': {
            ...
            'start_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "UUID('84a28da6-c0a7-41d8-8e0c-54e3f6873993')", 'unique': 'True', 'max_length': '36'}),
        ...
        'core.provider': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "UUID('f51e2189-dd3f-47a3-b04c-8c580fbd34b4')", 'unique': 'True', 'max_length': '36'}),
