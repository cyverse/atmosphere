...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        """
        Add default status types
        """
        orm.StatusType.objects.create(name="pending")
    ...
    models = {
        ...
        'core.allocationrequest': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "UUID('19fb3c4a-4691-4b57-8ab9-ff9e95a153c6')", 'max_length': '36'})
        },
        'core.application': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "UUID('ae8d6a9a-0221-4fd7-a66c-e27219d5a73d')", 'unique': 'True', 'max_length': '36'})
        },
        ...
        'core.identity': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'provider': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['core.Provider']"}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "UUID('180881b7-03a6-4cee-9ad5-8e7f56049ad6')", 'unique': 'True', 'max_length': '36'})
        },
        ...
        'core.project': {
            ...
            'start_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "UUID('d8b26d80-c20e-4776-9c07-35fb86ecb563')", 'unique': 'True', 'max_length': '36'}),
        ...
        'core.provider': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "UUID('b920b6f0-6989-4c62-b770-e55069c36480')", 'unique': 'True', 'max_length': '36'}),
        ...
        'core.quotarequest': {
            ...
            'start_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 1, 26, 0, 0)'}),
            'status': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['core.StatusType']"}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "UUID('7eb9913b-47d8-4364-9ffd-49f46ce63437')", 'max_length': '36'})
        },
        'core.scripttype': {
