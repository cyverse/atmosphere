...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for machine in orm.ProviderMachine.objects.all():
            numbers = machine.version_tmp.number
            machine.version = "%s.%s.%s" % (numbers[0], numbers[1], numbers[2])
            machine.save()
    ...
    models = {
        ...
        'core.application': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "UUID('3d0bb4cb-4683-498f-8ae0-ff1124141a40')", 'unique': 'True', 'max_length': '36'})
        },
        ...
        'core.identity': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'provider': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['core.Provider']"}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "UUID('0352abbe-4a5a-4915-828a-a39a3ba05426')", 'unique': 'True', 'max_length': '36'})
        },
        ...
        'core.project': {
            ...
            'start_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "UUID('4572aaf9-4cfe-4fe8-b468-66968e25137c')", 'unique': 'True', 'max_length': '36'}),
        ...
        'core.provider': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "UUID('adb79be9-d3a2-4336-8736-6df59a68960c')", 'unique': 'True', 'max_length': '36'}),
