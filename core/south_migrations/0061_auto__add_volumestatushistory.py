...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'VolumeStatusHistory'
        db.create_table('volume_status_history', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('volume', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Volume'])),
            ('status', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.VolumeStatus'])),
            ('device', self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True)),
            ('instance_alias', self.gf('django.db.models.fields.CharField')(max_length=36, null=True, blank=True)),
            ('start_date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 8, 20, 0, 0))),
            ('end_date', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
        ))
        db.send_create_signal('core', ['VolumeStatusHistory'])


    def backwards(self, orm):
        # Deleting model 'VolumeStatusHistory'
        db.delete_table('volume_status_history')
    ...
    models = {
        ...
        'core.flow': {
            ...
            'start_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 8, 20, 0, 0)'}),
