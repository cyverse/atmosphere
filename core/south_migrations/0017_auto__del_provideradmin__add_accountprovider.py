...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'ProviderAdmin'
        db.delete_table('provider_admin')

        # Adding model 'AccountProvider'
        db.create_table('provider_admin', (
        ...
        db.send_create_signal('core', ['AccountProvider'])


    def backwards(self, orm):
        # Adding model 'ProviderAdmin'
        db.create_table('provider_admin', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('identity', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Identity'])),
            ('provider', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Provider'])),
        ))
        db.send_create_signal('core', ['ProviderAdmin'])

        # Deleting model 'AccountProvider'
        db.delete_table('provider_admin')
    ...
    models = {
        ...
        'core.flow': {
            ...
            'start_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 9, 13, 0, 0)'}),
