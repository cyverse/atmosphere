...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MachineRequest.new_machine_version'
        db.add_column('machine_request', 'new_machine_version',
                      self.gf('django.db.models.fields.CharField')(default='1.0.0', max_length=128),
                      keep_default=False)
    ...
    def backwards(self, orm):
        # Deleting field 'MachineRequest.new_machine_version'
        db.delete_column('machine_request', 'new_machine_version')

        # Deleting field 'ProviderMachine.version'
        db.delete_column('provider_machine', 'version')
    ...
    models = {
        ...
        'core.application': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "UUID('b37f9f00-7065-482b-aa4d-2988dc325a45')", 'unique': 'True', 'max_length': '36'})
        },
        ...
        'core.flow': {
            ...
            'start_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 1, 12, 0, 0)'}),
        ...
        'core.identity': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'provider': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['core.Provider']"}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "UUID('9aaecf4a-eec6-4a88-8edc-69667db60031')", 'unique': 'True', 'max_length': '36'})
        },
        ...
        'core.machinerequest': {
            ...
            'new_machine_version_tmp': ('core.fields.VersionNumberField', [], {'default': '-2130706432'}),
        ...
        'core.project': {
            ...
            'start_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "UUID('d296539f-48a3-4e13-a3e3-8b1a0c86385c')", 'unique': 'True', 'max_length': '36'}),
        ...
        'core.provider': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "UUID('735586f9-bbda-41da-a51f-270be26ae721')", 'unique': 'True', 'max_length': '36'}),
        ...
        'core.providermachine': {
            ...
            'version_tmp': ('core.fields.VersionNumberField', [], {'default': '-2130706432'})
        },
