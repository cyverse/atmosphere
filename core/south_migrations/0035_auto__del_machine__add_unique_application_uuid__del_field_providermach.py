...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table(db.shorten_name('machine_tags'))

        # Adding unique constraint on 'Application', fields ['uuid']
        db.create_unique('application', ['uuid'])

        # Deleting field 'ProviderMachine.machine'
        db.delete_column('provider_machine', 'machine_id')


        # Changing field 'ProviderMachine.application'
        db.alter_column('provider_machine', 'application_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['core.Application']))

    def backwards(self, orm):
        # Removing unique constraint on 'Application', fields ['uuid']
        db.delete_unique('application', ['uuid'])
        ...
        db.create_table('machine', (
            ...
            ('application', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Application'], null=True)),
        ...
        m2m_table_name = db.shorten_name('machine_tags')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('machine', models.ForeignKey(orm['core.machine'], null=False)),
            ('tag', models.ForeignKey(orm['core.tag'], null=False))
        ))
        db.create_unique(m2m_table_name, ['machine_id', 'tag_id'])

        # Adding field 'ProviderMachine.machine'
        db.add_column('provider_machine', 'machine',
                      self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['core.Machine']),
                      keep_default=False)


        # Changing field 'ProviderMachine.application'
        db.alter_column('provider_machine', 'application_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Application'], null=True))
