...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ApplicationThreshold'
        db.create_table('application_threshold', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('application', self.gf('django.db.models.fields.related.ForeignKey')(related_name='threshold', to=orm['core.Application'])),
            ('memory_min', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('storage_min', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal('core', ['ApplicationThreshold'])


    def backwards(self, orm):
        # Deleting model 'ApplicationThreshold'
        db.delete_table('application_threshold')
    ...
    models = {
        ...
        'core.applicationthreshold': {
            ...
            'application': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'threshold'", 'to': "orm['core.Application']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'core.flow': {
            ...
            'start_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 5, 29, 0, 0)'}),
