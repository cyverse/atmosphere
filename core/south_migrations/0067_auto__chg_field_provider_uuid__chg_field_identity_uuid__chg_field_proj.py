...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Provider.uuid'
        db.alter_column('provider', 'uuid', self.gf('django.db.models.fields.CharField')(default=123412341234, unique=True, max_length=36))

        # Changing field 'Identity.uuid'
        db.alter_column('identity', 'uuid', self.gf('django.db.models.fields.CharField')(default=234123412341, unique=True, max_length=36))

        # Changing field 'Project.uuid'
        db.alter_column('project', 'uuid', self.gf('django.db.models.fields.CharField')(default=341234123412, unique=True, max_length=36))

    def backwards(self, orm):

        # Changing field 'Provider.uuid'
        db.alter_column('provider', 'uuid', self.gf('django.db.models.fields.CharField')(unique=True, max_length=36, null=True))

        # Changing field 'Identity.uuid'
        db.alter_column('identity', 'uuid', self.gf('django.db.models.fields.CharField')(unique=True, max_length=36, null=True))

        # Changing field 'Project.uuid'
        db.alter_column('project', 'uuid', self.gf('django.db.models.fields.CharField')(unique=True, max_length=36, null=True))
    ...
    models = {
        ...
        'core.flow': {
            ...
            'start_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 12, 18, 0, 0)'}),
