...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        #))
        #db.send_create_signal('core', ['Leadership'])
    ...
    def backwards(self, orm):
        ...
        #))
        #db.create_unique('group_leaders', ['group_id', 'atmosphereuser_id'])
    ...
    models = {
        ...
        'core.flow': {
            ...
            'start_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 20, 0, 0)'}),
