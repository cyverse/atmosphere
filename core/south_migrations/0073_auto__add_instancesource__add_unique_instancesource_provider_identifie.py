...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'InstanceSource'
        db.create_table('instance_source', (
            ...
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.AtmosphereUser'], null=True, blank=True)),
            ('created_by_identity', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Identity'], null=True, blank=True)),
            ('start_date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
            ('end_date', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
        ))
        db.send_create_signal('core', ['InstanceSource'])

        # Adding unique constraint on 'InstanceSource', fields ['provider', 'identifier']
        db.create_unique('instance_source', ['provider_id', 'identifier'])

        # Adding field 'Instance.source'
        db.add_column('instance', 'source',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='source_type', null=True, to=orm['core.InstanceSource']),
                      keep_default=False)


    def backwards(self, orm):
        # Removing unique constraint on 'InstanceSource', fields ['provider', 'identifier']
        db.delete_unique('instance_source', ['provider_id', 'identifier'])

        # Deleting model 'InstanceSource'
        db.delete_table('instance_source')

        # Deleting field 'Instance.source'
        db.delete_column('instance', 'source_id')
    ...
    models = {
        ...
        'core.application': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "UUID('2838c532-8ed9-48ca-839a-a650d1400a15')", 'unique': 'True', 'max_length': '36'})
        },
        ...
        'core.identity': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'provider': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['core.Provider']"}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "UUID('a56759a5-1e7c-4a06-b4d7-18aec484b5f9')", 'unique': 'True', 'max_length': '36'})
        },
        ...
        'core.project': {
            ...
            'start_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "UUID('4a346836-e173-47aa-a7af-06396bbc19c3')", 'unique': 'True', 'max_length': '36'}),
        ...
        'core.provider': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "UUID('3bd2ae53-4161-496e-976a-5ac7c809483b')", 'unique': 'True', 'max_length': '36'}),
        ...
        'core.providermachine': {
            'Meta': {'unique_together': "(('provider', 'identifier'),)", 'object_name': 'ProviderMachine', 'db_table': "'provider_machine'"},
            'application': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['core.Application']"}),
