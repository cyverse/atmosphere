...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MaintenanceRecord.provider'
        db.add_column('maintenance_record', 'provider',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Provider'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MaintenanceRecord.provider'
        db.delete_column('maintenance_record', 'provider_id')
    ...
    models = {
        ...
        'core.flow': {
            ...
            'start_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 9, 5, 0, 0)'}),
