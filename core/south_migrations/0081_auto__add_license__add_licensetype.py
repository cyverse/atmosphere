...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('license', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=256)),
            ('license_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.LicenseType'])),
            ('license_text', self.gf('django.db.models.fields.TextField')()),
            ('allow_imaging', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.AtmosphereUser'])),
        ))
        db.send_create_signal('core', ['License'])

        # Adding model 'LicenseType'
        db.create_table('license_type', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=128)),
            ('description', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal('core', ['LicenseType'])
        # Adding initial objects for 'LicenseType'
        orm.LicenseType.objects.create(
                name='URL', description="The complete URL address "\
                "(Ex: https://www.github.com/license.txt")
        orm.LicenseType.objects.create(
                name='Full Text',
                description="A full-text copy of the license (HTML Okay)")

        # Adding M2M table for field new_machine_licenses on 'MachineRequest'
        m2m_table_name = db.shorten_name('machine_request_new_machine_licenses')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('machinerequest', models.ForeignKey(orm['core.machinerequest'], null=False)),
            ('license', models.ForeignKey(orm['core.license'], null=False))
        ))
        db.create_unique(m2m_table_name, ['machinerequest_id', 'license_id'])

        # Adding M2M table for field licenses on 'ProviderMachine'
        m2m_table_name = db.shorten_name('provider_machine_licenses')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('providermachine', models.ForeignKey(orm['core.providermachine'], null=False)),
            ('license', models.ForeignKey(orm['core.license'], null=False))
        ))
        db.create_unique(m2m_table_name, ['providermachine_id', 'license_id'])


    def backwards(self, orm):
        # Deleting model 'License'
        db.delete_table('license')

        # Deleting model 'LicenseType'
        db.delete_table('license_type')

        # Removing M2M table for field new_machine_licenses on 'MachineRequest'
        db.delete_table(db.shorten_name('machine_request_new_machine_licenses'))

        # Removing M2M table for field licenses on 'ProviderMachine'
        db.delete_table(db.shorten_name('provider_machine_licenses'))
    ...
    models = {
        ...
        'core.allocationrequest': {
            'Meta': {'object_name': 'AllocationRequest', 'db_table': "'allocation_request'"},
            'admin_message': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '1024', 'blank': 'True'}),
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['core.AtmosphereUser']"}),
            'description': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '1024', 'blank': 'True'}),
            'end_date': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'membership': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['core.IdentityMembership']"}),
            'request': ('django.db.models.fields.TextField', [], {}),
            'start_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 1, 26, 0, 0)'}),
            'status': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['core.StatusType']"}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "UUID('4cef3130-07dd-4e44-bdf0-c872abd6e90f')", 'max_length': '36'})
        },
        'core.application': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "UUID('4a43dbcd-460b-42a8-8748-cfb18505a460')", 'unique': 'True', 'max_length': '36'})
        },
        ...
        'core.bootscript': {
            'Meta': {'object_name': 'BootScript', 'db_table': "'boot_script'"},
            'applications': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'scripts'", 'symmetrical': 'False', 'to': "orm['core.Application']"}),
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['core.AtmosphereUser']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'instances': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'scripts'", 'symmetrical': 'False', 'to': "orm['core.Instance']"}),
            'run_every_deploy': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'script_text': ('django.db.models.fields.TextField', [], {}),
            'script_type': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['core.ScriptType']"}),
        ...
        'core.identity': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'provider': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['core.Provider']"}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "UUID('2474899b-bf2f-4172-8ae8-38fca5092264')", 'unique': 'True', 'max_length': '36'})
        },
        ...
        'core.instance': {
            ...
            'source': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'instances'", 'to': "orm['core.InstanceSource']"}),
        ...
        'core.instancesource': {
            ...
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'source_set'", 'null': 'True', 'to': "orm['core.AtmosphereUser']"}),
        ...
        'core.license': {
            'Meta': {'object_name': 'License', 'db_table': "'license'"},
            'allow_imaging': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['core.AtmosphereUser']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'license_text': ('django.db.models.fields.TextField', [], {}),
            'license_type': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['core.LicenseType']"}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '256'})
        },
        'core.licensetype': {
            'Meta': {'object_name': 'LicenseType', 'db_table': "'license_type'"},
            'description': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '128'})
        },
        ...
        'core.machinerequest': {
            ...
            'new_machine_licenses': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['core.License']", 'null': 'True', 'blank': 'True'}),
        ...
        'core.project': {
            ...
            'start_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "UUID('9bd1fbc2-63cd-4b19-a7ea-e53144cd4caa')", 'unique': 'True', 'max_length': '36'}),
        ...
        'core.provider': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "UUID('a5ab79d9-a39d-451d-aea2-2a2c290c2564')", 'unique': 'True', 'max_length': '36'}),
        ...
        'core.providermachine': {
            'Meta': {'object_name': 'ProviderMachine', 'db_table': "'provider_machine'", '_ormbases': ['core.InstanceSource']},
            'application': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['core.Application']"}),
            ...
            'licenses': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['core.License']", 'null': 'True', 'blank': 'True'}),
        ...
        'core.quotarequest': {
            'Meta': {'object_name': 'QuotaRequest', 'db_table': "'quota_request'"},
            'admin_message': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '1024', 'blank': 'True'}),
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['core.AtmosphereUser']"}),
            'description': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '1024', 'blank': 'True'}),
            'end_date': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            ...
            'start_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 1, 26, 0, 0)'}),
            'status': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['core.StatusType']"}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "UUID('46470632-5615-4051-92a0-e4d3460d524c')", 'max_length': '36'})
        },
        'core.scripttype': {
            'Meta': {'object_name': 'ScriptType', 'db_table': "'script_type'"},
            'description': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '128'})
        },
        ...
        'core.statustype': {
            'Meta': {'object_name': 'StatusType', 'db_table': "'status_type'"},
