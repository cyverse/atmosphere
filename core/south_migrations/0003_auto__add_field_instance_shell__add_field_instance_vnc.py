...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Instance.shell'
        db.add_column('instance', 'shell',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Instance.vnc'
        db.add_column('instance', 'vnc',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Instance.shell'
        db.delete_column('instance', 'shell')

        # Deleting field 'Instance.vnc'
        db.delete_column('instance', 'vnc')
    ...
    models = {
        ...
        'core.instance': {
            ...
            'start_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 4, 25, 0, 0)'}),
