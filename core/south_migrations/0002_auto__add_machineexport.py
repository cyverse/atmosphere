...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'MachineExport'
        db.create_table('machine_export', (
            ...
            ('export_owner', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('export_format', self.gf('django.db.models.fields.CharField')(max_length=256)),
            ('export_file', self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True)),
            ('start_date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 2, 20, 0, 0))),
            ('end_date', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
        ))
        db.send_create_signal('core', ['MachineExport'])


    def backwards(self, orm):
        # Deleting model 'MachineExport'
        db.delete_table('machine_export')
    ...
    models = {
        ...
        'core.instance': {
            ...
            'start_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 20, 0, 0)'}),
        ...
        'core.machineexport': {
            ...
            'export_owner': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'instance': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['core.Instance']"}),
            'start_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 20, 0, 0)'}),
