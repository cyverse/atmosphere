...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ApplicationThreshold.application'
        db.alter_column('application_threshold', 'application_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, to=orm['core.Application']))
        # Adding unique constraint on 'ApplicationThreshold', fields ['application']
        db.create_unique('application_threshold', ['application_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'ApplicationThreshold', fields ['application']
        db.delete_unique('application_threshold', ['application_id'])


        # Changing field 'ApplicationThreshold.application'
        db.alter_column('application_threshold', 'application_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Application']))
    ...
    models = {
        ...
        'core.flow': {
            ...
            'start_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 6, 10, 0, 0)'}),
