...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'NodeController.port'
        db.add_column('node_controller', 'port',
                      self.gf('django.db.models.fields.IntegerField')(default=22),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'NodeController.port'
        db.delete_column('node_controller', 'port')
    ...
    models = {
        ...
        'core.flow': {
            ...
            'start_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 15, 0, 0)'}),
