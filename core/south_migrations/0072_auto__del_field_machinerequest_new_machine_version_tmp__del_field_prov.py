...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'MachineRequest.new_machine_version_tmp'
        db.delete_column('machine_request', 'new_machine_version_tmp')

        # Deleting field 'ProviderMachine.version_tmp'
        db.delete_column('provider_machine', 'version_tmp')


    def backwards(self, orm):
        # Adding field 'MachineRequest.new_machine_version_tmp'
        db.add_column('machine_request', 'new_machine_version_tmp',
                      self.gf('core.fields.VersionNumberField')(default=-2130706432),
                      keep_default=False)

        # Adding field 'ProviderMachine.version_tmp'
        db.add_column('provider_machine', 'version_tmp',
                      self.gf('core.fields.VersionNumberField')(default=-2130706432),
                      keep_default=False)
    ...
    models = {
        ...
        'core.application': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "UUID('47785b0d-ebab-4f43-9932-b3d3c170bd04')", 'unique': 'True', 'max_length': '36'})
        },
        ...
        'core.identity': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'provider': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['core.Provider']"}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "UUID('04b36f0a-0e4d-4924-a761-c15b4b7c59c5')", 'unique': 'True', 'max_length': '36'})
        },
        ...
        'core.project': {
            ...
            'start_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "UUID('ed2e7a07-e2df-4f93-8216-35c96c820232')", 'unique': 'True', 'max_length': '36'}),
        ...
        'core.provider': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "UUID('f448a482-d4bf-450c-bb69-3e7ca0125791')", 'unique': 'True', 'max_length': '36'}),
