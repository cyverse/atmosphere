...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        #Not necessary due to 0076 (Rename table)
        ## Deleting model 'MachineSource'
        #db.delete_table('machine_source')

        ## Deleting model 'VolumeSource'
        #db.delete_table('volume_source')

        ## Deleting field 'Volume.end_date'
        #db.delete_column('volume', 'end_date')

        ## Deleting field 'Volume.id'
        #db.delete_column('volume', u'id')

        ## Deleting field 'Volume.created_by_identity'
        #db.delete_column('volume', 'created_by_identity_id')

        ## Deleting field 'Volume.created_by'
        #db.delete_column('volume', 'created_by_id')

        ## Deleting field 'Volume.alias'
        #db.delete_column('volume', 'alias')

        ## Deleting field 'Volume.provider'
        #db.delete_column('volume', 'provider_id')

        ## Deleting field 'Volume.start_date'
        #db.delete_column('volume', 'start_date')

        ## Adding field 'Volume.instancesource_ptr'
        #db.add_column('volume', u'instancesource_ptr',
        #              self.gf('django.db.models.fields.related.OneToOneField')(default=-1, to=orm['core.InstanceSource'], unique=True, primary_key=True),
        #              keep_default=False)
        ## Removing unique constraint on 'ProviderMachine', fields ['provider', 'identifier']
        #db.delete_unique('provider_machine', ['provider_id', 'identifier'])

        ## Deleting field 'ProviderMachine.created_by_identity'
        #db.delete_column('provider_machine', 'created_by_identity_id')

        ## Deleting field 'ProviderMachine.end_date'
        #db.delete_column('provider_machine', 'end_date')

        ## Deleting field 'ProviderMachine.provider'
        #db.delete_column('provider_machine', 'provider_id')

        ## Deleting field 'ProviderMachine.identifier'
        #db.delete_column('provider_machine', 'identifier')

        ## Deleting field 'ProviderMachine.created_by'
        #db.delete_column('provider_machine', 'created_by_id')

        ## Deleting field 'ProviderMachine.start_date'
        #db.delete_column('provider_machine', 'start_date')
        pass


    def backwards(self, orm):
        #Not necessary due to 0076 (Rename table)
        ## Adding model 'MachineSource'
        #db.create_table('machine_source', (
        ...
        #    (u'instancesource_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['core.InstanceSource'], unique=True, primary_key=True)),
        #))
        #db.send_create_signal('core', ['MachineSource'])

        ## Adding model 'VolumeSource'
        #db.create_table('volume_source', (
        ...
        ## Adding field 'Volume.end_date'
        #db.add_column('volume', 'end_date',
        #              self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
        #              keep_default=False)


        ## User chose to not deal with backwards NULL issues for 'Volume.id'
        #raise RuntimeError("Cannot reverse this migration. 'Volume.id' and its values cannot be restored.")
        #
        ## The following code is provided here to aid in writing a correct migration        # Adding field 'Volume.id'
        #db.add_column('volume', u'id',
        #              self.gf('django.db.models.fields.AutoField')(primary_key=True),
        #              keep_default=False)

        ## Adding field 'Volume.created_by_identity'
        #db.add_column('volume', 'created_by_identity',
        #              self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Identity'], null=True),
        #              keep_default=False)

        ## Adding field 'Volume.created_by'
        #db.add_column('volume', 'created_by',
        #              self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.AtmosphereUser'], null=True),
        #              keep_default=False)


        ## User chose to not deal with backwards NULL issues for 'Volume.alias'
        #raise RuntimeError("Cannot reverse this migration. 'Volume.alias' and its values cannot be restored.")
        #
        ## The following code is provided here to aid in writing a correct migration        # Adding field 'Volume.alias'
        #db.add_column('volume', 'alias',
        #              self.gf('django.db.models.fields.CharField')(max_length=256),
        #              keep_default=False)


        ## User chose to not deal with backwards NULL issues for 'Volume.provider'
        #raise RuntimeError("Cannot reverse this migration. 'Volume.provider' and its values cannot be restored.")
        #
        ## The following code is provided here to aid in writing a correct migration        # Adding field 'Volume.provider'
        #db.add_column('volume', 'provider',
        #              self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Provider']),
        #              keep_default=False)

        ## Adding field 'Volume.start_date'
        #db.add_column('volume', 'start_date',
        #              self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2015, 1, 13, 0, 0)),
        #              keep_default=False)

        ## Deleting field 'Volume.instancesource_ptr'
        #db.delete_column('volume', u'instancesource_ptr_id')

        ## Adding field 'ProviderMachine.created_by_identity'
        #db.add_column('provider_machine', 'created_by_identity',
        #              self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Identity'], null=True),
        #              keep_default=False)

        ## Adding field 'ProviderMachine.end_date'
        #db.add_column('provider_machine', 'end_date',
        #              self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
        #              keep_default=False)


        ## User chose to not deal with backwards NULL issues for 'ProviderMachine.provider'
        #raise RuntimeError("Cannot reverse this migration. 'ProviderMachine.provider' and its values cannot be restored.")
        #
        ## The following code is provided here to aid in writing a correct migration        # Adding field 'ProviderMachine.provider'
        #db.add_column('provider_machine', 'provider',
        #              self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Provider']),
        #              keep_default=False)


        ## User chose to not deal with backwards NULL issues for 'ProviderMachine.identifier'
        #raise RuntimeError("Cannot reverse this migration. 'ProviderMachine.identifier' and its values cannot be restored.")
        #
        ## The following code is provided here to aid in writing a correct migration        # Adding field 'ProviderMachine.identifier'
        #db.add_column('provider_machine', 'identifier',
        #              self.gf('django.db.models.fields.CharField')(max_length=256),
        #              keep_default=False)

        ## Adding field 'ProviderMachine.created_by'
        #db.add_column('provider_machine', 'created_by',
        #              self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.AtmosphereUser'], null=True),
        #              keep_default=False)

        ## Adding field 'ProviderMachine.start_date'
        #db.add_column('provider_machine', 'start_date',
        #              self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2015, 1, 13, 0, 0)),
        #              keep_default=False)

        ## Adding unique constraint on 'ProviderMachine', fields ['provider', 'identifier']
        #db.create_unique('provider_machine', ['provider_id', 'identifier'])
        pass
    ...
    models = {
        ...
        'core.application': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "UUID('0c4f02b9-1279-4d7f-80f1-6d2802a8a79b')", 'unique': 'True', 'max_length': '36'})
        },
        'core.applicationbookmark': {
            'Meta': {'object_name': 'ApplicationBookmark', 'db_table': "'application_bookmark'"},
            'application': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'bookmarks'", 'to': "orm['core.Application']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'bookmarks'", 'to': "orm['core.AtmosphereUser']"})
        },
        ...
        'core.applicationscore': {
            'Meta': {'object_name': 'ApplicationScore', 'db_table': "'application_score'"},
            'application': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'scores'", 'to': "orm['core.Application']"}),
            'end_date': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'core.applicationthreshold': {
            'Meta': {'object_name': 'ApplicationThreshold', 'db_table': "'application_threshold'"},
            'application': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'threshold'", 'unique': 'True', 'to': "orm['core.Application']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'memory_min': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'storage_min': ('django.db.models.fields.IntegerField', [], {'default': '0'})
        },
        'core.atmosphereuser': {
        ...
        'core.group': {
            ...
            'applications': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'related_name': "'members'", 'blank': 'True', 'through': "orm['core.ApplicationMembership']", 'to': "orm['core.Application']"}),
            ...
            'provider_machines': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'related_name': "'members'", 'blank': 'True', 'through': "orm['core.ProviderMachineMembership']", 'to': "orm['core.ProviderMachine']"}),
        ...
        'core.identity': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'provider': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['core.Provider']"}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "UUID('f0d140c3-9479-415d-bc9a-3f119010c6de')", 'unique': 'True', 'max_length': '36'})
        },
        'core.identitymembership': {
            'Meta': {'unique_together': "(('identity', 'member'),)", 'object_name': 'IdentityMembership', 'db_table': "'identity_membership'"},
        ...
        'core.instance': {
            ...
            'source': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'source_type'", 'null': 'True', 'to': "orm['core.InstanceSource']"}),
        ...
        'core.instancesource': {
            'Meta': {'unique_together': "(('provider', 'identifier'),)", 'object_name': 'InstanceSource', 'db_table': "'instance_source'"},
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['core.AtmosphereUser']", 'null': 'True', 'blank': 'True'}),
            'created_by_identity': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['core.Identity']", 'null': 'True', 'blank': 'True'}),
            'end_date': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'core.machinerequest': {
            ...
            'new_machine_memory_min': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            ...
            'new_machine_storage_min': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
        ...
        'core.project': {
            ...
            'name': ('django.db.models.fields.CharField', [], {'max_length': '256'}),
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'projects'", 'to': "orm['core.Group']"}),
            'start_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "UUID('163ddbd2-1596-4a83-9d63-c608a3ca9d3e')", 'unique': 'True', 'max_length': '36'}),
        ...
        'core.provider': {
            ...
            'traits': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['core.Trait']", 'null': 'True', 'blank': 'True'}),
            'type': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['core.ProviderType']"}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "UUID('58179d82-0ff3-4937-9146-7d159dd303b2')", 'unique': 'True', 'max_length': '36'}),
        ...
        'core.providermachine': {
            ...
            'application': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['core.Application']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'version': ('django.db.models.fields.CharField', [], {'default': "'1.0.0'", 'max_length': '128'})
        },
        'core.providermachinemembership': {
            'Meta': {'unique_together': "(('provider_machine', 'group'),)", 'object_name': 'ProviderMachineMembership', 'db_table': "'provider_machine_membership'"},
            'can_share': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'group': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['core.Group']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'provider_machine': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['core.ProviderMachine']"})
        },
        'core.providermembership': {
            'Meta': {'unique_together': "(('provider', 'member'),)", 'object_name': 'ProviderMembership', 'db_table': "'provider_membership'"},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'member': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['core.Group']"}),
            'provider': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['core.Provider']"})
        },
        ...
        'core.quota': {
            ...
            'cpu': ('django.db.models.fields.IntegerField', [], {'default': '16', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'memory': ('django.db.models.fields.IntegerField', [], {'default': '128', 'null': 'True', 'blank': 'True'}),
            'storage': ('django.db.models.fields.IntegerField', [], {'default': '10', 'null': 'True', 'blank': 'True'}),
        ...
        'core.t': {
            'Meta': {'object_name': 'T', 'db_table': "'transaction'"},
            'V': ('django.db.models.fields.CharField', [], {'max_length': '36'}),
            'end_date': ('django.db.models.fields.DateTimeField', [], {'null': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'start_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 1, 13, 0, 0)'})
        },
        ...
        'core.volume': {
            'Meta': {'object_name': 'Volume', 'db_table': "'volume'", '_ormbases': ['core.InstanceSource']},
            'description': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            u'instancesource_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['core.InstanceSource']", 'unique': 'True', 'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '256'}),
