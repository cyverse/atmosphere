...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'VolumeStatus'
        db.create_table('volume_status', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=128)),
        ))
        db.send_create_signal('core', ['VolumeStatus'])


    def backwards(self, orm):
        # Deleting model 'VolumeStatus'
        db.delete_table('volume_status')
    ...
    models = {
        ...
        'core.flow': {
            ...
            'start_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 8, 4, 0, 0)'}),
