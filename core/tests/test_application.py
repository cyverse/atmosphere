...
class CoreApplicationTestCase(unittest.TestCase):
    def assertAccessList(self, expected_result):
        ...
        return self.assertTrue(
            usernames == expected_result,
            "%s != ExpectedResult(%s)" % (usernames, expected_result)
        )
...
class TestApplicationAccessList(CoreApplicationTestCase):
    ...
    def setUp(self):
        self.app_helper = CoreApplicationHelper("Pattern Match app test", now())
    ...
    def test_deny_allow_logic(self):
        ...
        expected_result = [
            u'cdosborn', u'cyversedemo1', u'cyversedemo2', u'cyversedemo3',
            u'lenards', u'steve'
        ]
    ...
    def test_simple_access(self):
        ...
        expected_result = [u'cyversedemo1', u'cyversedemo2', u'cyversedemo3']
        self.assertAccessList(expected_result)
        self.app.access_list.clear()
