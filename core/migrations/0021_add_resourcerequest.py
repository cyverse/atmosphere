    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('allocation', models.ForeignKey(to='core.Allocation', null=True)),
                ('created_by', models.ForeignKey(to=settings.AUTH_USER_MODEL)),
                ('membership', models.ForeignKey(to='core.IdentityMembership')),
                ('quota', models.ForeignKey(to='core.Quota', null=True)),
                ('status', models.ForeignKey(default=core.models.status_type.get_status_type_id, to='core.StatusType')),
            ],
            options={
