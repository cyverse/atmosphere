...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('flowtype', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=256, blank=True)),
            ('start_date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 8, 27, 0, 0))),
            ('end_date', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
        ))
        db.send_create_signal('core', ['FlowType'])

        # Adding model 'Flow'
        db.create_table('flow', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ...
            ('type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.FlowType'])),
    ...
    def backwards(self, orm):
        ...
        db.delete_table('flowtype')

        # Deleting model 'Flow'
        db.delete_table('flow')
    ...
    models = {
        ...
        'core.flow': {
            ...
            'start_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 27, 0, 0)'}),
