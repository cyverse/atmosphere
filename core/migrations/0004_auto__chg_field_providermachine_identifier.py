...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ProviderMachine.identifier'
        db.alter_column('provider_machine', 'identifier', self.gf('django.db.models.fields.CharField')(max_length=256))

    def backwards(self, orm):

        # Changing field 'ProviderMachine.identifier'
        db.alter_column('provider_machine', 'identifier', self.gf('django.db.models.fields.CharField')(max_length=128))
    ...
    models = {
        ...
        'core.instance': {
            ...
            'start_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 4, 26, 0, 0)'}),
