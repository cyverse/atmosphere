...
class Migration(DataMigration):
    ...
    def backwards(self, orm):
        ...
        uuid_count = self.remove_uuids(orm.Provider)
        print "Removed %s UUIDs to Provider" % uuid_count
        uuid_count = self.remove_uuids(orm.Identity)
        print "Removed %s UUIDs to Identity" % uuid_count
        uuid_count = self.remove_uuids(orm.Project)
        print "Removed %s UUIDs to Project" % uuid_count


    def remove_uuids(self, ModelCls, model_key="id"):
        for obj in ModelCls.objects.all():
            obj.uuid = None
            obj.save()
        return ModelCls.objects.count()
