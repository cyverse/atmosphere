...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Application.created_by_identity'
        db.add_column('application', 'created_by_identity',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Identity'], null=True),
                      keep_default=False)

        # Adding M2M table for field tags on 'Application'
        m2m_table_name = db.shorten_name('application_tags')
        ...
        db.create_unique(m2m_table_name, ['application_id', 'tag_id'])

        # Adding field 'ProviderMachine.application'
        db.add_column('provider_machine', 'application',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Application'], null=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Application.created_by_identity'
        db.delete_column('application', 'created_by_identity_id')

        # Removing M2M table for field tags on 'Application'
        db.delete_table(db.shorten_name('application_tags'))

        # Deleting field 'ProviderMachine.application'
        db.delete_column('provider_machine', 'application_id')
