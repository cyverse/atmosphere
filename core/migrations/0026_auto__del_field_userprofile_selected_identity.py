...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'UserProfile.selected_identity'
        db.delete_column('user_profile', 'selected_identity_id')


    def backwards(self, orm):
        # Adding field 'UserProfile.selected_identity'
        db.add_column('user_profile', 'selected_identity',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Identity'], null=True, blank=True),
                      keep_default=False)
