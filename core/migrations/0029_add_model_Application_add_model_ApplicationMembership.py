...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('application', (
            ...
            ('start_date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 11, 21, 0, 0))),
            ('end_date', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
        ))
        db.send_create_signal('core', ['Application'])

        # Adding model 'ApplicationMembership'
        db.create_table('application_membership', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('core', ['ApplicationMembership'])

        # Adding unique constraint on 'ApplicationMembership', fields ['application', 'group']
        db.create_unique('application_membership', ['application_id', 'group_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'ApplicationMembership', fields ['application', 'group']
        db.delete_unique('application_membership', ['application_id', 'group_id'])

        # Deleting model 'Application'
        db.delete_table('application')

        # Deleting model 'ApplicationMembership'
        db.delete_table('application_membership')
