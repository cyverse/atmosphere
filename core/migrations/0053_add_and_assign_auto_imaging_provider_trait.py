...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        # Create the Trait
        trait = orm.Trait.objects.create(name="Auto-Imaging", description="If applied, all image requests will be automatically approved, verified, and completed (with email) and without staff intervention.")
        # Apply the Trait
        for prov in orm.Provider.objects.all():
            # Filter what providers should apply the trait here:
            prov.traits.add(trait)
    ...
    models = {
        ...
        'core.flow': {
            ...
            'start_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 4, 21, 0, 0)'}),
