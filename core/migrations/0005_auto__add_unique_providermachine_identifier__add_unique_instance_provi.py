...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'ProviderMachine', fields ['identifier']
        db.create_unique('provider_machine', ['identifier'])

        # Adding unique constraint on 'Instance', fields ['provider_alias']
        db.create_unique('instance', ['provider_alias'])


    def backwards(self, orm):
        # Removing unique constraint on 'Instance', fields ['provider_alias']
        db.delete_unique('instance', ['provider_alias'])

        # Removing unique constraint on 'ProviderMachine', fields ['identifier']
        db.delete_unique('provider_machine', ['identifier'])
    ...
    models = {
        ...
        'core.machine': {
            ...
            'start_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 5, 30, 0, 0)'}),
            'tags': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['core.Tag']", 'symmetrical': 'False'})
        },
        'core.machineexport': {
