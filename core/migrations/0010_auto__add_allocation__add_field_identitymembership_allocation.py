...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('allocation', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('threshold', self.gf('django.db.models.fields.IntegerField')(default=10080, null=True, blank=True)),
            ('delta', self.gf('django.db.models.fields.IntegerField')(default=20160, null=True, blank=True)),
        ))
        db.send_create_signal('core', ['Allocation'])

        # Adding field 'IdentityMembership.allocation'
        db.add_column('identity_membership', 'allocation',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Allocation'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'Allocation'
        db.delete_table('allocation')

        # Deleting field 'IdentityMembership.allocation'
        db.delete_column('identity_membership', 'allocation_id')
