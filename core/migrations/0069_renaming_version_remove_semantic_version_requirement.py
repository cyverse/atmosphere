...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Renaming field 'MachineRequest.new_machine_version'
        db.rename_column('machine_request', 'new_machine_version', 'new_machine_version_tmp')
        # Renaming field 'ProviderMachine.version'
        db.rename_column('provider_machine', 'version', 'version_tmp')


    def backwards(self, orm):
        # Renaming field 'MachineRequest.new_machine_version'
        db.rename_column('machine_request', 'new_machine_version_tmp', 'new_machine_version')
        # Renaming field 'ProviderMachine.version'
        db.rename_column('provider_machine', 'version_tmp', 'version')
    ...
    models = {
        ...
        'core.application': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "UUID('44831a6f-6bf6-4a0d-93a9-b2c27c075156')", 'unique': 'True', 'max_length': '36'})
        },
        ...
        'core.identity': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'provider': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['core.Provider']"}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "UUID('72a22ba2-e3bd-40b0-9b1c-ea3040f61a56')", 'unique': 'True', 'max_length': '36'})
        },
        ...
        'core.project': {
            ...
            'start_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "UUID('742268bb-fa99-47bc-aae8-a139c1959d15')", 'unique': 'True', 'max_length': '36'}),
        ...
        'core.provider': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "UUID('60dd5953-fb13-43dd-bf4f-c00fec3ec0f8')", 'unique': 'True', 'max_length': '36'}),
