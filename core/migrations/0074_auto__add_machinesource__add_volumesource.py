...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        'core.application': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "UUID('ae998b97-2807-4dab-afa0-8e7cfad053e6')", 'unique': 'True', 'max_length': '36'})
        },
        ...
        'core.identity': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'provider': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['core.Provider']"}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "UUID('d3469059-5c6c-4a0c-aadf-2951e6fbaadd')", 'unique': 'True', 'max_length': '36'})
        },
        ...
        'core.machinesource': {
            'Meta': {'object_name': 'MachineSource', 'db_table': "'machine_source'", '_ormbases': ['core.InstanceSource']},
            'application': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['core.Application']"}),
        ...
        'core.project': {
            ...
            'start_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "UUID('d9147c73-3e32-4333-be5d-1c7873be4563')", 'unique': 'True', 'max_length': '36'}),
        ...
        'core.provider': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "UUID('a6eac27d-8f37-410a-be85-7ca526bd754e')", 'unique': 'True', 'max_length': '36'}),
        ...
        'core.volumesource': {
            'Meta': {'object_name': 'VolumeSource', 'db_table': "'volume_source'", '_ormbases': ['core.InstanceSource']},
            'description': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            u'instancesource_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['core.InstanceSource']", 'unique': 'True', 'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '256'}),
            'size': ('django.db.models.fields.IntegerField', [], {})
