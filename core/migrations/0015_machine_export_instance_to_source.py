...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AddField(
            ...
            name='source',
            field=models.ForeignKey(blank=True, to='core.InstanceSource', null=True),
        ),
        migrations.RunPython(copy_data_to_new_field, do_nothing),
        ...
        migrations.AlterField(
            model_name='machineexport',
            name='source',
            field=models.ForeignKey(to='core.InstanceSource'),
        ),
    ]
