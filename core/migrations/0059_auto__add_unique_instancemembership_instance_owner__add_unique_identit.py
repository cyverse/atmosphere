...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'InstanceMembership', fields ['instance', 'owner']
        db.create_unique('instance_membership', ['instance_id', 'owner_id'])
        # Adding unique constraint on 'IdentityMembership', fields ['identity', 'member']
        db.create_unique('identity_membership', ['identity_id', 'member_id'])
        # Adding unique constraint on 'ProviderMembership', fields ['provider', 'member']
        db.create_unique('provider_membership', ['provider_id', 'member_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'ProviderMembership', fields ['provider', 'member']
        db.delete_unique('provider_membership', ['provider_id', 'member_id'])
        # Removing unique constraint on 'IdentityMembership', fields ['identity', 'member']
        db.delete_unique('identity_membership', ['identity_id', 'member_id'])
        # Removing unique constraint on 'InstanceMembership', fields ['instance', 'owner']
        db.delete_unique('instance_membership', ['instance_id', 'owner_id'])
