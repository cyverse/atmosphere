...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ProviderCredential'
        db.create_table('provider_credential', (
        ...
        db.send_create_signal('core', ['ProviderCredential'])
    ...
    def backwards(self, orm):
        # Deleting model 'ProviderCredential'
        db.delete_table('provider_credential')
