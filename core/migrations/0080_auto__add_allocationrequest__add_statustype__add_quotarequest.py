...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('allocation_request', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('uuid', self.gf('django.db.models.fields.CharField')(default=UUID('d1348944-3639-4357-af6a-e2f60aba8b66'), max_length=36)),
            ...
            ('status', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.StatusType'])),
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.AtmosphereUser'])),
            ('membership', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.IdentityMembership'])),
            ('admin_message', self.gf('django.db.models.fields.CharField')(default='', max_length=1024, blank=True)),
            ('start_date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2015, 1, 26, 0, 0))),
            ('end_date', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
        ))
        db.send_create_signal('core', ['AllocationRequest'])

        # Adding model 'StatusType'
        db.create_table('status_type', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        # Adding model 'QuotaRequest'
        db.create_table('quota_request', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('uuid', self.gf('django.db.models.fields.CharField')(default=UUID('fa7f37a0-ac08-4bdb-98cf-8bf86bad3915'), max_length=36)),
            ('request', self.gf('django.db.models.fields.TextField')()),
            ('description', self.gf('django.db.models.fields.CharField')(default='', max_length=1024, blank=True)),
            ('status', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.StatusType'])),
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.AtmosphereUser'])),
        ...
        db.send_create_signal('core', ['QuotaRequest'])


    def backwards(self, orm):
        # Deleting model 'AllocationRequest'
        db.delete_table('allocation_request')

        # Deleting model 'StatusType'
        db.delete_table('status_type')

        # Deleting model 'QuotaRequest'
        db.delete_table('quota_request')
    ...
    models = {
        ...
        'core.allocationrequest': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "UUID('a6eb2d18-bbe6-49b9-8bec-0ba0600c2525')", 'max_length': '36'})
        },
        'core.application': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "UUID('e307af02-836c-4b8c-b95e-42d0892e913b')", 'unique': 'True', 'max_length': '36'})
        },
        ...
        'core.identity': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'provider': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['core.Provider']"}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "UUID('ea43d7b6-98ed-4f41-b567-63c379225f56')", 'unique': 'True', 'max_length': '36'})
        },
        ...
        'core.project': {
            ...
            'start_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "UUID('63c4cabc-8b58-4027-8335-9be7c9db8070')", 'unique': 'True', 'max_length': '36'}),
        ...
        'core.provider': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "UUID('50f57757-2dac-402e-82b2-e103e5d8995a')", 'unique': 'True', 'max_length': '36'}),
        ...
        'core.quotarequest': {
            ...
            'start_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 1, 26, 0, 0)'}),
            'status': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['core.StatusType']"}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "UUID('a83ccb2a-38b1-4d6b-941d-42d8aa34cbc4')", 'max_length': '36'})
        },
        'core.scripttype': {
