...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'MachineRequest.new_machine_forked'
        db.add_column('machine_request', 'new_machine_forked',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'MachineRequest.new_machine_forked'
        db.delete_column('machine_request', 'new_machine_forked')
    ...
    models = {
        ...
        'core.flow': {
            ...
            'start_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 1, 15, 0, 0)'}),
