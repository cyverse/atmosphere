...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PlatformType'
        db.create_table('platform_type', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=256)),
            ('start_date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 10, 18, 0, 0))),
            ('end_date', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
        ))
        db.send_create_signal('core', ['PlatformType'])

        # Adding field 'Provider.virtualization'
        db.add_column('provider', 'virtualization',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.PlatformType'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'PlatformType'
        db.delete_table('platform_type')

        # Deleting field 'Provider.virtualization'
        db.delete_column('provider', 'virtualization_id')
    ...
    models = {
        ...
        'core.flow': {
            ...
            'start_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 18, 0, 0)'}),
        ...
        'core.provider': {
            ...
            'virtualization': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['core.PlatformType']", 'null': 'True', 'blank': 'True'})
        },
