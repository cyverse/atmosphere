...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ApplicationBookmark'
        db.create_table('application_bookmark', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.AtmosphereUser'])),
            ('application', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Application'])),
        ))
        db.send_create_signal('core', ['ApplicationBookmark'])


    def backwards(self, orm):
        # Deleting model 'ApplicationBookmark'
        db.delete_table('application_bookmark')
