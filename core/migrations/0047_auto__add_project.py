...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field applications on 'Project'
        m2m_table_name = db.shorten_name('project_applications')
        ...
        db.create_unique(m2m_table_name, ['project_id', 'application_id'])

        # Adding M2M table for field instances on 'Project'
        m2m_table_name = db.shorten_name('project_instances')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('project', models.ForeignKey(orm['core.project'], null=False)),
            ('instance', models.ForeignKey(orm['core.instance'], null=False))
        ))
        db.create_unique(m2m_table_name, ['project_id', 'instance_id'])

        # Adding M2M table for field volumes on 'Project'
        m2m_table_name = db.shorten_name('project_volumes')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('project', models.ForeignKey(orm['core.project'], null=False)),
            ('volume', models.ForeignKey(orm['core.volume'], null=False))
        ))
        db.create_unique(m2m_table_name, ['project_id', 'volume_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field applications on 'Project'
        db.delete_table(db.shorten_name('project_applications'))

        # Removing M2M table for field instances on 'Project'
        db.delete_table(db.shorten_name('project_instances'))

        # Removing M2M table for field volumes on 'Project'
        db.delete_table(db.shorten_name('project_volumes'))
    ...
    models = {
        ...
        'core.flow': {
            ...
            'start_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 4, 2, 0, 0)'}),
