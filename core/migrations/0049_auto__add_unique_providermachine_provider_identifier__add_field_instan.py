...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'InstanceStatusHistory.size'
        db.add_column('instance_status_history', 'size',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.ProviderSize'], null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'InstanceStatusHistory.size'
        db.delete_column('instance_status_history', 'size_id')
    ...
    models = {
        ...
        'core.instancestatushistory': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'instance': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['core.Instance']"}),
            'size': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['core.ProviderSize']", 'null': 'True', 'blank': 'True'}),
            'start_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 4, 14, 0, 0)'}),
