...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ApplicationScore'
        db.create_table('application_score', (
        ...
        db.send_create_signal('core', ['ApplicationScore'])


    def backwards(self, orm):
        # Deleting model 'ApplicationScore'
        db.delete_table('application_score')
    ...
    models = {
        ...
        'core.flow': {
            ...
            'start_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 13, 0, 0)'}),
